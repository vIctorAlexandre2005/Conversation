        ...
        <>
            ...
            >
                <Box p={"1rem"} gap={4} display={"flex"} alignItems={"center"}>
                    ...
                    {photoURL ? <Img src={photoURL} w={"3rem"} h={"3rem"} borderRadius={"50%"} /> : <AtSignIcon boxSize={"1.5rem"} color={"bunker.50"} />}
                    <Box>
                        <Text fontSize={"1.2rem"} color={"bunker.50"} overflow={"hidden"} textAlign={"initial"} textOverflow={"ellipsis"}>
                            {name}
                        </Text>
                    </Box>
                </Box>
